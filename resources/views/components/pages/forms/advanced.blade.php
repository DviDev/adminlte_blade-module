<x-lte::pages.layout-base title="General Form" breadcrumb="General Form" :use_sidebar="true">
    @push('styles')
        ...
        <link rel="stylesheet"
              href="{{asset("assets/modules/lte/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css")}}">
        <!-- Tempusdominus Bootstrap 4 -->
        <link rel="stylesheet"
              href="{{asset("assets/modules/lte/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css")}}">

        <link rel="stylesheet"
              href="{{asset("assets/modules/lte/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css")}}">
        <!-- Bootstrap4 Duallistbox -->
        <link rel="stylesheet"
              href="{{asset("assets/modules/lte/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css")}}">
        <!-- BS Stepper -->
        <link rel="stylesheet" href="{{asset("assets/modules/lte/plugins/bs-stepper/css/bs-stepper.min.css")}}">
        <!-- dropzonejs -->
        <link rel="stylesheet" href="{{asset("assets/modules/lte/plugins/dropzone/min/dropzone.min.css")}}">
        <!-- Select2 -->
    ...
    @push('scripts')
        ...
        <script src="{{asset("assets/modules/lte/plugins/inputmask/jquery.inputmask.min.js")}}"></script>
        <!-- Bootstrap4 Duallistbox -->
        <script
            src="{{asset("assets/modules/lte/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js")}}"></script>
        ...
        <!-- bootstrap color picker -->
        <script
            src="{{asset("assets/modules/lte/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js")}}"></script>
        <!-- Tempusdominus Bootstrap 4 -->
        <script
            src="{{asset("assets/modules/lte/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js")}}"></script>
        <!-- Bootstrap Switch -->
        <script src="{{asset("assets/modules/lte/plugins/bootstrap-switch/js/bootstrap-switch.min.js")}}"></script>
        <!-- BS-Stepper -->
        <script src="{{asset("assets/modules/lte/plugins/bs-stepper/js/bs-stepper.min.js")}}"></script>
        <!-- dropzonejs -->
        <script src="{{asset("assets/modules/lte/plugins/dropzone/min/dropzone.min.js")}}"></script>
        <!-- AdminLTE App -->
