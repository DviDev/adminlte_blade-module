<x-lte::pages.layout-base title="Pace" breadcrumb="Pace" :use_sidebar="true">
    <x-slot:content>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    You can Change Pace Styles, Checkout the <a href="https://adminlte.io/docs/3.1/" target="_blank"
                                                                rel="noopener noreferrer">AdminLTE Official Docs</a> in
                    Online.
                    <br>
    ...
    @push('styles')
        <link rel="stylesheet"
              href="{{asset('assets/modules/lte/plugins/pace-progress/themes/black/pace-theme-flat-top.css')}}">
    @endpush
    @push('scripts')
        <!-- jQuery -->
        ...
        <!-- pace-progress -->
        <script src="{{asset('assets/modules/lte/plugins/pace-progress/pace.min.js')}}"></script>
        <!-- AdminLTE App -->
