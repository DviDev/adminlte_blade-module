<x-lte::pages.layout-base title="UI Ribbons" breadcrumb="UI Ribbons" :use_sidebar="true">
    <x-slot:content>
                                ...
                                <div class="row mt-4">
                                    <div class="col-sm-4">
                                        <div class="position-relative">
                                            <img src="{{asset('assets/modules/lte/dist/img/photo1.png')}}" alt="Photo 1"
                                                 class="img-fluid">
                                            <div class="ribbon-wrapper ribbon-lg">
                                                <div class="ribbon bg-success text-lg">
                                                    Ribbon
                                    ...
                                    <div class="col-sm-4">
                                        <div class="position-relative">
                                            <img src="{{asset('assets/modules/lte/dist/img/photo2.png')}}" alt="Photo 2"
                                                 class="img-fluid">
                                            <div class="ribbon-wrapper ribbon-xl">
                                                <div class="ribbon bg-warning text-lg">
                                                    Ribbon
                                    ...
                                    <div class="col-sm-4">
                                        <div class="position-relative" style="min-height: 180px;">
                                            <img src="{{asset('assets/modules/lte/dist/img/photo3.jpg')}}" alt="Photo 3"
                                                 class="img-fluid">
                                            <div class="ribbon-wrapper ribbon-xl">
                                                <div class="ribbon bg-danger text-xl">
                                                    Ribbon
